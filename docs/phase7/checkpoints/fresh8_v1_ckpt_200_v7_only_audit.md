...
- Status: **PASS**
- Validated episodes: 162/162
- PlannerContext versions: {'0.6': 162}
- Score policies: {'geneval2_pass_count_then_gm@1': 162}
- Execution profiles: {'qwen_dual_backend@1': 162}
- Image backends: {'qianwen_image_edit': 344, 'qwen_image': 204}
- Difficulty mix: {'easy': 63, 'hard': 40, 'medium': 59}
- Evaluated image attempts: 548
- Aggregate first Agent attempt atom pass rate: 939/1146 (81.9%)
- Aggregate submitted reducer-best atom pass rate: 1053/1146 (91.9%)
- Net submitted-over-first atom gain: +114
- Geneval2 Soft-TIFA AM, first Agent attempts: 82.16
- Geneval2 Soft-TIFA AM, submitted reducer-best attempts: 90.85 (+8.69)
- Geneval2 Soft-TIFA GM, first Agent attempts: 43.70
- Geneval2 Soft-TIFA GM, submitted reducer-best attempts: 72.90 (+29.20)
- Geneval2 Soft-TIFA GM, per-trajectory peak attempts: 73.55 (+29.85)
- Submitted-to-peak GM gap: 0.65
- Episodes with all atoms passed: 92/162
- Historical-best submissions: 47/162
- Regression exposure: 54/162 episodes, 114 image actions
- Ineffective image actions: 86
- Historical edit branches: 86
- Canonical action counts: {'edit_image': 344, 'generate_image': 204, 'query_skill': 156, 'submit_attempt': 162}
- Action/backend counts: {'edit_image|qianwen_image_edit': 344, 'generate_image|qwen_image': 204}
- Scheduler profiles: 6 recorded launches
- Teacher model IDs: ['gpt-5.5']
- Rejected raw Teacher turns: 68 total (0 pass the corrected current validator; 0 remain protocol/reference-invalid; 68 remain instruction-quality-invalid).
...
- This batch mix: {'easy': 63, 'hard': 40, 'medium': 59}.
