...
- Status: **PASS**
- Validated episodes: 180/180
- PlannerContext versions: {'0.6': 180}
- Score policies: {'geneval2_pass_count_then_gm@1': 180}
- Execution profiles: {'qwen_dual_backend@1': 180}
- Image backends: {'qianwen_image_edit': 366, 'qwen_image': 225}
- Difficulty mix: {'easy': 72, 'hard': 44, 'medium': 64}
- Evaluated image attempts: 591
- Aggregate first Agent attempt atom pass rate: 1041/1263 (82.4%)
- Aggregate submitted reducer-best atom pass rate: 1168/1263 (92.5%)
- Net submitted-over-first atom gain: +127
- Geneval2 Soft-TIFA AM, first Agent attempts: 82.72
- Geneval2 Soft-TIFA AM, submitted reducer-best attempts: 91.48 (+8.75)
- Geneval2 Soft-TIFA GM, first Agent attempts: 45.34
- Geneval2 Soft-TIFA GM, submitted reducer-best attempts: 75.19 (+29.85)
- Geneval2 Soft-TIFA GM, per-trajectory peak attempts: 75.77 (+30.43)
- Submitted-to-peak GM gap: 0.58
- Episodes with all atoms passed: 108/180
- Historical-best submissions: 49/180
- Regression exposure: 57/180 episodes, 118 image actions
- Ineffective image actions: 90
- Historical edit branches: 88
- Canonical action counts: {'edit_image': 366, 'generate_image': 225, 'query_skill': 171, 'submit_attempt': 180}
- Action/backend counts: {'edit_image|qianwen_image_edit': 366, 'generate_image|qwen_image': 225}
- Scheduler profiles: 6 recorded launches
- Teacher model IDs: ['gpt-5.5']
- Rejected raw Teacher turns: 72 total (0 pass the corrected current validator; 0 remain protocol/reference-invalid; 72 remain instruction-quality-invalid).
...
- This batch mix: {'easy': 72, 'hard': 44, 'medium': 64}.
