...
- Status: **PASS**
- Validated episodes: 3/3
- PlannerContext versions: {'0.6': 3}
- Score policies: {'geneval2_pass_count_then_gm@1': 3}
- Execution profiles: {'qwen_dual_backend@1': 3}
- Image backends: {'qianwen_image_edit': 1, 'qwen_image': 3}
- Difficulty mix: {'easy': 1, 'medium': 2}
- Evaluated image attempts: 4
- Aggregate first Agent attempt atom pass rate: 18/19 (94.7%)
- Aggregate submitted reducer-best atom pass rate: 19/19 (100.0%)
- Net submitted-over-first atom gain: +1
- Geneval2 Soft-TIFA AM, first Agent attempts: 94.41
- Geneval2 Soft-TIFA AM, submitted reducer-best attempts: 98.51 (+4.10)
- Geneval2 Soft-TIFA GM, first Agent attempts: 89.97
- Geneval2 Soft-TIFA GM, submitted reducer-best attempts: 98.47 (+8.50)
- Geneval2 Soft-TIFA GM, per-trajectory peak attempts: 98.47 (+8.50)
- Submitted-to-peak GM gap: 0.00
- Episodes with all atoms passed: 3/3
- Historical-best submissions: 0/3
- Regression exposure: 0/3 episodes, 0 image actions
- Ineffective image actions: 0
- Historical edit branches: 0
- Canonical action counts: {'edit_image': 1, 'generate_image': 3, 'query_skill': 2, 'submit_attempt': 3}
- Action/backend counts: {'edit_image|qianwen_image_edit': 1, 'generate_image|qwen_image': 3}
...
- This batch mix: {'easy': 1, 'medium': 2}.
