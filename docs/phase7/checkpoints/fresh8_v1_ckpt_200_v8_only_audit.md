...
- Status: **PASS**
- Validated episodes: 37/37
- PlannerContext versions: {'0.6': 37}
- Score policies: {'geneval2_pass_count_then_gm@1': 37}
- Execution profiles: {'qwen_dual_backend@1': 37}
- Image backends: {'qianwen_image_edit': 84, 'qwen_image': 47}
- Difficulty mix: {'easy': 12, 'hard': 10, 'medium': 15}
- Evaluated image attempts: 131
- Aggregate first Agent attempt atom pass rate: 213/265 (80.4%)
- Aggregate submitted reducer-best atom pass rate: 241/265 (90.9%)
- Net submitted-over-first atom gain: +28
- Geneval2 Soft-TIFA AM, first Agent attempts: 80.50
- Geneval2 Soft-TIFA AM, submitted reducer-best attempts: 91.19 (+10.69)
- Geneval2 Soft-TIFA GM, first Agent attempts: 38.65
- Geneval2 Soft-TIFA GM, submitted reducer-best attempts: 75.82 (+37.17)
- Geneval2 Soft-TIFA GM, per-trajectory peak attempts: 77.05 (+38.40)
- Submitted-to-peak GM gap: 1.23
- Episodes with all atoms passed: 19/37
- Historical-best submissions: 12/37
- Regression exposure: 14/37 episodes, 17 image actions
- Ineffective image actions: 27
- Historical edit branches: 14
- Canonical action counts: {'edit_image': 84, 'generate_image': 47, 'query_skill': 36, 'submit_attempt': 37}
- Action/backend counts: {'edit_image|qianwen_image_edit': 84, 'generate_image|qwen_image': 47}
- Scheduler profiles: 2 recorded launches
- Teacher model IDs: ['gpt-5.5']
- Rejected raw Teacher turns: 9 total (0 pass the corrected current validator; 0 remain protocol/reference-invalid; 9 remain instruction-quality-invalid).
...
- This batch mix: {'easy': 12, 'hard': 10, 'medium': 15}.
...
| `phase3_ep_174` | medium | 5 | 7/8 | 87.50 | 13.12 | 7/8 (`a_001`) | 91.37 | 86.63 | 86.63 (`a_001`) | +0 |
...
| `phase3_ep_178` | easy | 5 | 1/4 | 28.75 | 0.16 | 3/4 (`a_004`) | 75.24 | 34.45 | 34.45 (`a_004`) | +2 |
| `phase3_ep_179` | easy | 2 | 5/6 | 87.82 | 80.35 | 6/6 (`a_001`) | 99.93 | 99.93 | 99.93 (`a_001`) | +1 |
| `phase3_ep_180` | medium | 5 | 3/6 | 53.56 | 1.77 | 4/6 (`a_003`) | 64.04 | 20.37 | 20.37 (`a_003`) | +1 |
| `phase3_ep_181` | medium | 5 | 6/8 | 74.72 | 5.43 | 7/8 (`a_004`) | 89.24 | 78.22 | 78.22 (`a_004`) | +1 |
| `phase3_ep_182` | medium | 5 | 6/8 | 74.97 | 1.30 | 8/8 (`a_004`) | 94.52 | 93.05 | 93.05 (`a_004`) | +2 |
| `phase3_ep_183` | hard | 5 | 8/10 | 79.36 | 6.96 | 8/10 (`a_003`) | 81.41 | 22.12 | 22.12 (`a_003`) | +0 |
| `phase3_ep_184` | hard | 5 | 8/10 | 77.17 | 47.18 | 9/10 (`a_003`) | 86.91 | 82.14 | 82.14 (`a_003`) | +1 |
...
| `phase3_ep_188` | medium | 5 | 5/6 | 83.33 | 6.60 | 5/6 (`a_004`) | 83.33 | 8.56 | 8.56 (`a_004`) | +0 |
| `phase3_ep_189` | medium | 5 | 6/8 | 76.51 | 14.28 | 7/8 (`a_001`) | 90.66 | 84.71 | 84.71 (`a_001`) | +1 |
| `phase3_ep_190` | medium | 5 | 6/8 | 73.51 | 5.90 | 7/8 (`a_003`) | 86.91 | 43.79 | 43.79 (`a_003`) | +1 |
| `phase3_ep_191` | hard | 5 | 8/10 | 80.27 | 41.67 | 9/10 (`a_003`) | 86.45 | 26.08 | 69.22 (`a_002`) | +1 |
| `phase3_ep_192` | hard | 5 | 7/10 | 69.59 | 1.51 | 9/10 (`a_004`) | 91.18 | 82.36 | 82.36 (`a_004`) | +2 |
| `phase3_ep_193` | easy | 1 | 4/4 | 97.72 | 97.64 | 4/4 (`a_000`) | 97.72 | 97.64 | 97.64 (`a_000`) | +0 |
| `phase3_ep_194` | easy | 2 | 3/4 | 75.09 | 25.15 | 4/4 (`a_001`) | 98.90 | 98.88 | 98.88 (`a_001`) | +1 |
| `phase3_ep_195` | easy | 5 | 4/6 | 66.67 | 3.28 | 5/6 (`a_004`) | 86.13 | 75.13 | 77.57 (`a_003`) | +1 |
| `phase3_ep_196` | medium | 5 | 4/6 | 66.18 | 0.18 | 5/6 (`a_003`) | 83.20 | 2.69 | 2.69 (`a_003`) | +1 |
| `phase3_ep_197` | medium | 1 | 8/8 | 100.00 | 100.00 | 8/8 (`a_000`) | 100.00 | 100.00 | 100.00 (`a_000`) | +0 |
| `phase3_ep_198` | medium | 5 | 7/8 | 87.92 | 65.46 | 7/8 (`a_004`) | 88.23 | 70.07 | 70.07 (`a_004`) | +0 |
| `phase3_ep_199` | hard | 5 | 8/10 | 79.93 | 6.53 | 8/10 (`a_003`) | 84.20 | 70.67 | 70.67 (`a_003`) | +0 |
| `phase3_ep_200` | hard | 5 | 6/10 | 63.44 | 1.08 | 6/10 (`a_000`) | 63.44 | 1.08 | 1.08 (`a_000`) | +0 |
