...
- Status: **PASS**
- Validated episodes: 140/140
- PlannerContext versions: {'0.6': 140}
- Score policies: {'geneval2_pass_count_then_gm@1': 140}
- Execution profiles: {'qwen_dual_backend@1': 140}
- Image backends: {'qianwen_image_edit': 281, 'qwen_image': 170}
- Difficulty mix: {'easy': 54, 'hard': 34, 'medium': 52}
- Evaluated image attempts: 451
- Aggregate first Agent attempt atom pass rate: 826/997 (82.8%)
- Aggregate submitted reducer-best atom pass rate: 924/997 (92.7%)
- Net submitted-over-first atom gain: +98
- Geneval2 Soft-TIFA AM, first Agent attempts: 83.11
- Geneval2 Soft-TIFA AM, submitted reducer-best attempts: 91.79 (+8.69)
- Geneval2 Soft-TIFA GM, first Agent attempts: 46.52
- Geneval2 Soft-TIFA GM, submitted reducer-best attempts: 75.50 (+28.98)
- Geneval2 Soft-TIFA GM, per-trajectory peak attempts: 76.14 (+29.62)
- Submitted-to-peak GM gap: 0.64
- Episodes with all atoms passed: 85/140
- Historical-best submissions: 34/140
- Regression exposure: 44/140 episodes, 90 image actions
- Ineffective image actions: 65
- Historical edit branches: 70
- Canonical action counts: {'edit_image': 281, 'generate_image': 170, 'query_skill': 135, 'submit_attempt': 140}
- Action/backend counts: {'edit_image|qianwen_image_edit': 281, 'generate_image|qwen_image': 170}
- Scheduler profiles: 6 recorded launches
- Teacher model IDs: ['gpt-5.5']
- Rejected raw Teacher turns: 61 total (0 pass the corrected current validator; 0 remain protocol/reference-invalid; 61 remain instruction-quality-invalid).
...
- This batch mix: {'easy': 54, 'hard': 34, 'medium': 52}.
