...
- PlannerContext versions: {'0.6': 200}
- Score policies: {'geneval2_pass_count_then_gm@1': 200}
- Execution profiles: {'qwen_dual_backend@1': 200}
- Image backends: {'qianwen_image_edit': 431, 'qwen_image': 253}
- Difficulty mix: {'easy': 75, 'hard': 50, 'medium': 75}
- Evaluated image attempts: 684
- Aggregate first Agent attempt atom pass rate: 1159/1419 (81.7%)
- Aggregate submitted reducer-best atom pass rate: 1301/1419 (91.7%)
- Net submitted-over-first atom gain: +142
- Geneval2 Soft-TIFA AM, first Agent attempts: 81.87
- Geneval2 Soft-TIFA AM, submitted reducer-best attempts: 90.90 (+9.03)
- Geneval2 Soft-TIFA GM, first Agent attempts: 42.58
- Geneval2 Soft-TIFA GM, submitted reducer-best attempts: 73.50 (+30.92)
- Geneval2 Soft-TIFA GM, per-trajectory peak attempts: 74.25 (+31.67)
- Submitted-to-peak GM gap: 0.75
- Episodes with all atoms passed: 111/200
- Historical-best submissions: 60/200
- Regression exposure: 68/200 episodes, 131 image actions
- Ineffective image actions: 115
- Historical edit branches: 100
- Canonical action counts: {'edit_image': 431, 'generate_image': 253, 'query_skill': 193, 'submit_attempt': 200}
- Action/backend counts: {'edit_image|qianwen_image_edit': 431, 'generate_image|qwen_image': 253}
- Scheduler profiles: 7 recorded launches
- Teacher model IDs: ['gpt-5.5']
- Rejected raw Teacher turns: 82 total (0 pass the corrected current validator; 0 remain protocol/reference-invalid; 82 remain instruction-quality-invalid).
