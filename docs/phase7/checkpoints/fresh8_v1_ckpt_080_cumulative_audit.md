...
- Status: **PASS**
- Validated episodes: 80/80
- PlannerContext versions: {'0.6': 80}
- Score policies: {'geneval2_pass_count_then_gm@1': 80}
- Execution profiles: {'qwen_dual_backend@1': 80}
- Image backends: {'qianwen_image_edit': 148, 'qwen_image': 91}
- Difficulty mix: {'easy': 35, 'hard': 17, 'medium': 28}
- Evaluated image attempts: 239
- Aggregate first Agent attempt atom pass rate: 471/561 (84.0%)
- Aggregate submitted reducer-best atom pass rate: 528/561 (94.1%)
- Net submitted-over-first atom gain: +57
- Geneval2 Soft-TIFA AM, first Agent attempts: 84.16
- Geneval2 Soft-TIFA AM, submitted reducer-best attempts: 93.18 (+9.02)
- Geneval2 Soft-TIFA GM, first Agent attempts: 48.64
- Geneval2 Soft-TIFA GM, submitted reducer-best attempts: 80.97 (+32.33)
- Geneval2 Soft-TIFA GM, per-trajectory peak attempts: 81.50 (+32.86)
- Submitted-to-peak GM gap: 0.52
- Episodes with all atoms passed: 56/80
- Historical-best submissions: 14/80
- Regression exposure: 19/80 episodes, 33 image actions
- Ineffective image actions: 35
- Historical edit branches: 35
- Canonical action counts: {'edit_image': 148, 'generate_image': 91, 'query_skill': 75, 'submit_attempt': 80}
- Action/backend counts: {'edit_image|qianwen_image_edit': 148, 'generate_image|qwen_image': 91}
- Scheduler profiles: 6 recorded launches
- Teacher model IDs: ['gpt-5.5']
- Rejected raw Teacher turns: 47 total (0 pass the corrected current validator; 0 remain protocol/reference-invalid; 47 remain instruction-quality-invalid).
...
- This batch mix: {'easy': 35, 'hard': 17, 'medium': 28}.
