...
- Status: **PASS**
- Validated episodes: 7/7
- PlannerContext versions: {'0.6': 7}
- Score policies: {'geneval2_pass_count_then_gm@1': 7}
- Execution profiles: {'qwen_dual_backend@1': 7}
- Image backends: {'qianwen_image_edit': 22, 'qwen_image': 12}
- Difficulty mix: {'easy': 3, 'hard': 2, 'medium': 2}
- Evaluated image attempts: 34
- Aggregate first Agent attempt atom pass rate: 37/51 (72.5%)
- Aggregate submitted reducer-best atom pass rate: 42/51 (82.4%)
- Net submitted-over-first atom gain: +5
- Geneval2 Soft-TIFA AM, first Agent attempts: 71.99
- Geneval2 Soft-TIFA AM, submitted reducer-best attempts: 80.60 (+8.61)
- Geneval2 Soft-TIFA GM, first Agent attempts: 10.28
- Geneval2 Soft-TIFA GM, submitted reducer-best attempts: 42.72 (+32.44)
- Geneval2 Soft-TIFA GM, per-trajectory peak attempts: 44.63 (+34.35)
- Submitted-to-peak GM gap: 1.91
- Episodes with all atoms passed: 1/7
- Historical-best submissions: 5/7
- Regression exposure: 5/7 episodes, 11 image actions
- Ineffective image actions: 7
- Historical edit branches: 6
- Canonical action counts: {'edit_image': 22, 'generate_image': 12, 'query_skill': 7, 'submit_attempt': 7}
- Action/backend counts: {'edit_image|qianwen_image_edit': 22, 'generate_image|qwen_image': 12}
...
- This batch mix: {'easy': 3, 'hard': 2, 'medium': 2}.
