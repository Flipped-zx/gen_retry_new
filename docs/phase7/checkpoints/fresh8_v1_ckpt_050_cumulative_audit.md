...
- Status: **PASS**
- Validated episodes: 50/50
- PlannerContext versions: {'0.6': 50}
- Score policies: {'geneval2_pass_count_then_gm@1': 50}
- Execution profiles: {'qwen_dual_backend@1': 50}
- Image backends: {'qianwen_image_edit': 91, 'qwen_image': 57}
- Difficulty mix: {'easy': 20, 'hard': 12, 'medium': 18}
- Evaluated image attempts: 148
- Aggregate first Agent attempt atom pass rate: 306/361 (84.8%)
- Aggregate submitted reducer-best atom pass rate: 339/361 (93.9%)
- Net submitted-over-first atom gain: +33
- Geneval2 Soft-TIFA AM, first Agent attempts: 84.29
- Geneval2 Soft-TIFA AM, submitted reducer-best attempts: 93.23 (+8.94)
- Geneval2 Soft-TIFA GM, first Agent attempts: 49.85
- Geneval2 Soft-TIFA GM, submitted reducer-best attempts: 82.02 (+32.18)
- Geneval2 Soft-TIFA GM, per-trajectory peak attempts: 82.65 (+32.80)
- Submitted-to-peak GM gap: 0.63
- Episodes with all atoms passed: 35/50
- Historical-best submissions: 7/50
- Regression exposure: 11/50 episodes, 16 image actions
- Ineffective image actions: 26
- Historical edit branches: 20
- Canonical action counts: {'edit_image': 91, 'generate_image': 57, 'query_skill': 47, 'submit_attempt': 50}
- Action/backend counts: {'edit_image|qianwen_image_edit': 91, 'generate_image|qwen_image': 57}
- Scheduler profiles: 5 recorded launches
- Teacher model IDs: ['gpt-5.5']
- Rejected raw Teacher turns: 36 total (0 pass the corrected current validator; 0 remain protocol/reference-invalid; 36 remain instruction-quality-invalid).
...
- This batch mix: {'easy': 20, 'hard': 12, 'medium': 18}.
