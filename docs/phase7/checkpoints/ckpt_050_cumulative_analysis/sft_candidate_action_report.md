...
- Canonical actions labeled: 245
- Raw rejected turns labeled excluded: 36
- SFT candidate actions: 164
- Valid query_skill actions retained with loss 0: 47

## Label Counts

| Label | Count |
| --- | ---: |
| `trainable_positive` | 193 |
| `recovery_positive` | 18 |
| `history_only_harmful` | 10 |
| `history_only_ineffective` | 24 |
