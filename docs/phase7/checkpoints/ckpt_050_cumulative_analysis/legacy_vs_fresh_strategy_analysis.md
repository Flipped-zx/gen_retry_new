...
The 50 completed trajectories used the selected fresh prompts and did not import legacy images, legacy attempts, or legacy parentage. Legacy evidence remains limited to the earlier read-only diagnostic reports under `docs/phase3/` and `artifacts/phase3/`.

- Fresh image attempts: 148 total; 57 generation/regeneration actions and 91 edit actions.
- Historical-best submissions: 7/50 trajectories.
