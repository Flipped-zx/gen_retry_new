...
- Status: **PASS**
- Validated episodes: 120/120
- PlannerContext versions: {'0.6': 120}
- Score policies: {'geneval2_pass_count_then_gm@1': 120}
- Execution profiles: {'qwen_dual_backend@1': 120}
- Image backends: {'qianwen_image_edit': 227, 'qwen_image': 145}
- Difficulty mix: {'easy': 48, 'hard': 30, 'medium': 42}
- Evaluated image attempts: 372
- Aggregate first Agent attempt atom pass rate: 702/849 (82.7%)
- Aggregate submitted reducer-best atom pass rate: 789/849 (92.9%)
- Net submitted-over-first atom gain: +87
- Geneval2 Soft-TIFA AM, first Agent attempts: 83.17
- Geneval2 Soft-TIFA AM, submitted reducer-best attempts: 92.23 (+9.06)
- Geneval2 Soft-TIFA GM, first Agent attempts: 49.17
- Geneval2 Soft-TIFA GM, submitted reducer-best attempts: 78.32 (+29.15)
- Geneval2 Soft-TIFA GM, per-trajectory peak attempts: 78.73 (+29.56)
- Submitted-to-peak GM gap: 0.41
- Episodes with all atoms passed: 78/120
- Historical-best submissions: 25/120
- Regression exposure: 34/120 episodes, 67 image actions
- Ineffective image actions: 53
- Historical edit branches: 54
- Canonical action counts: {'edit_image': 227, 'generate_image': 145, 'query_skill': 114, 'submit_attempt': 120}
- Action/backend counts: {'edit_image|qianwen_image_edit': 227, 'generate_image|qwen_image': 145}
- Scheduler profiles: 6 recorded launches
- Teacher model IDs: ['gpt-5.5']
- Rejected raw Teacher turns: 54 total (0 pass the corrected current validator; 0 remain protocol/reference-invalid; 54 remain instruction-quality-invalid).
...
- This batch mix: {'easy': 48, 'hard': 30, 'medium': 42}.
