...
- Status: **PASS**
- Validated episodes: 160/160
- PlannerContext versions: {'0.6': 160}
- Score policies: {'geneval2_pass_count_then_gm@1': 160}
- Execution profiles: {'qwen_dual_backend@1': 160}
- Image backends: {'qianwen_image_edit': 330, 'qwen_image': 197}
- Difficulty mix: {'easy': 61, 'hard': 38, 'medium': 61}
- Evaluated image attempts: 527
- Aggregate first Agent attempt atom pass rate: 932/1133 (82.3%)
- Aggregate submitted reducer-best atom pass rate: 1046/1133 (92.3%)
- Net submitted-over-first atom gain: +114
- Geneval2 Soft-TIFA AM, first Agent attempts: 82.51
- Geneval2 Soft-TIFA AM, submitted reducer-best attempts: 91.33 (+8.82)
- Geneval2 Soft-TIFA GM, first Agent attempts: 44.87
- Geneval2 Soft-TIFA GM, submitted reducer-best attempts: 74.54 (+29.67)
- Geneval2 Soft-TIFA GM, per-trajectory peak attempts: 75.19 (+30.32)
- Submitted-to-peak GM gap: 0.65
- Episodes with all atoms passed: 95/160
- Historical-best submissions: 42/160
- Regression exposure: 52/160 episodes, 107 image actions
- Ineffective image actions: 77
- Historical edit branches: 81
- Canonical action counts: {'edit_image': 330, 'generate_image': 197, 'query_skill': 153, 'submit_attempt': 160}
- Action/backend counts: {'edit_image|qianwen_image_edit': 330, 'generate_image|qwen_image': 197}
- Scheduler profiles: 6 recorded launches
- Teacher model IDs: ['gpt-5.5']
- Rejected raw Teacher turns: 67 total (0 pass the corrected current validator; 0 remain protocol/reference-invalid; 67 remain instruction-quality-invalid).
...
- This batch mix: {'easy': 61, 'hard': 38, 'medium': 61}.
