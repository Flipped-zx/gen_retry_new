...
- Canonical actions labeled: 504
- Raw rejected turns labeled excluded: 50
- SFT candidate actions: 328
- Valid query_skill actions retained with loss 0: 97

## Label Counts

| Label | Count |
| --- | ---: |
| `trainable_positive` | 384 |
| `recovery_positive` | 41 |
| `history_only_harmful` | 40 |
| `history_only_ineffective` | 39 |
