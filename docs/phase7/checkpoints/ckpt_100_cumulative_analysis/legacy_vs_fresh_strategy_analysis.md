...
The 100 completed trajectories used the selected fresh prompts and did not import legacy images, legacy attempts, or legacy parentage. Legacy evidence remains limited to the earlier read-only diagnostic reports under `docs/phase3/` and `artifacts/phase3/`.

- Fresh image attempts: 307 total; 117 generation/regeneration actions and 190 edit actions.
- Historical-best submissions: 19/100 trajectories.
