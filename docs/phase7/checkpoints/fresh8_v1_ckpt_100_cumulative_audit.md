...
- PlannerContext versions: {'0.6': 100}
- Score policies: {'geneval2_pass_count_then_gm@1': 100}
- Execution profiles: {'qwen_dual_backend@1': 100}
- Image backends: {'qianwen_image_edit': 190, 'qwen_image': 117}
- Difficulty mix: {'easy': 40, 'hard': 23, 'medium': 37}
- Evaluated image attempts: 307
- Aggregate first Agent attempt atom pass rate: 591/713 (82.9%)
- Aggregate submitted reducer-best atom pass rate: 666/713 (93.4%)
- Net submitted-over-first atom gain: +75
- Geneval2 Soft-TIFA AM, first Agent attempts: 83.59
- Geneval2 Soft-TIFA AM, submitted reducer-best attempts: 92.71 (+9.12)
- Geneval2 Soft-TIFA GM, first Agent attempts: 48.38
- Geneval2 Soft-TIFA GM, submitted reducer-best attempts: 78.71 (+30.33)
- Geneval2 Soft-TIFA GM, per-trajectory peak attempts: 79.20 (+30.82)
- Submitted-to-peak GM gap: 0.49
- Episodes with all atoms passed: 67/100
- Historical-best submissions: 19/100
- Regression exposure: 28/100 episodes, 52 image actions
- Ineffective image actions: 40
- Historical edit branches: 44
- Canonical action counts: {'edit_image': 190, 'generate_image': 117, 'query_skill': 97, 'submit_attempt': 100}
- Action/backend counts: {'edit_image|qianwen_image_edit': 190, 'generate_image|qwen_image': 117}
- Scheduler profiles: 6 recorded launches
- Teacher model IDs: ['gpt-5.5']
- Rejected raw Teacher turns: 50 total (0 pass the corrected current validator; 0 remain protocol/reference-invalid; 50 remain instruction-quality-invalid).
...
- This batch mix: {'easy': 40, 'hard': 23, 'medium': 37}.
