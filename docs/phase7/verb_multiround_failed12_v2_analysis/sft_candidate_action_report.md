...
- Canonical actions labeled: 71
- Raw rejected turns labeled excluded: 2
- SFT candidate actions: 36
- Valid query_skill actions retained with loss 0: 11

## Label Counts

| Label | Count |
| --- | ---: |
| `trainable_positive` | 39 |
| `recovery_positive` | 8 |
| `history_only_harmful` | 13 |
| `history_only_ineffective` | 11 |
