...
The 1000 completed trajectories used the selected fresh prompts and did not import legacy images, legacy attempts, or legacy parentage. Legacy evidence remains limited to the earlier read-only diagnostic reports under `docs/phase3/` and `artifacts/phase3/`.

- Fresh image attempts: 3443 total; 1174 generation/regeneration actions and 2269 edit actions.
- Historical-best submissions: 316/1000 trajectories.
