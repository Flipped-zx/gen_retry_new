...
- Canonical actions labeled: 95
- Raw rejected turns labeled excluded: 7
- SFT candidate actions: 55
- Valid query_skill actions retained with loss 0: 23
...
| `recovery_positive` | 10 |
| `history_only_harmful` | 12 |
